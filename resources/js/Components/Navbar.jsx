  ...
  return (
    <div className="navbar bg-indigo-950 border-b-2 border-indigo-950">
        <div className="flex lg:flex-none items-center">
            ...
            <div className="flex gap-3 flex-row px-6 justify-items-center ">
                {/* <svg
                    viewBox="0 0 496 512"
                    fill="white"
                    height="2em"
                ...
                {/* <LogoWorkPulse></LogoWorkPulse> */}
                <div className="w-10 m-auto">
                    <img src="http://localhost:8000/LogoWorkPulse.png" alt="LogoWorkPulse.png" />
                </div>
                <span className="text-2xl font-bold text-white m-auto">WorkPulse</span>
            </div>
        </div>
